...
<script>
  import entrust from '@/components/deal/order-list-entrust-full'
  import transaction from '@/components/deal/order-list-transaction-full'
  ...
  export default {
    name: 'order-list-full',
    components: {
      'hex-entrust-full': entrust,
      'hex-transaction-full': transaction,
