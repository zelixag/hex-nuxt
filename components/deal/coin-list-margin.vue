      ...
      <div v-bar
        ...
        <div>
          <div class="body clearfix"
            ...
            <div class='market'>
              <span class='colour'>
                <span class="market_from"><span
                  class="margin-label">{{item.borrowmultiple}}X</span>{{getSymble(item.symble).from}}</span>/{{getSymble(item.symble).to}}</span>
            </div>
            <div class="price">
  ...
  export default {
    ...
    methods: {
      ...
      goDeal(coinid) {
        ...
        this.$store.commit('set_local_margin_symble', coinid);
