          ...
          <div>
            <table class="hex_table">
              ...
              <tr>
                ...
                <th class="rt" style="min-width:40px;">
                ...
                <th class="rt" style="min-width:52px;">
                  <div>{{$t('deal.bargainPrice')}}</div>
                </th>
                <th class="rt" style="min-width: 89px;">
