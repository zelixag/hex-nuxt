  ...
  <div class="hex-flex">
    <div class="hex-flex_auto">
      <div class="announcement-body">
        <div class='goback'>
       <nuxt-link to="/help">{{$t('home.footerHelp')}}</nuxt-link>   > {{$t('patch.TokenIntroduction')}}
        </div>
        <div class="headline">
          {{$t('patch.TokenIntroduction')}}
        </div>
        <div class="inner ovh">
          <ul class="loading por" v-hex-loading="loading">
            ...
            <li v-if="coinData.length<=0&&total!=''" class="articleNone">
              <div class="pic">
