...
$(function(){
	...
	$("#hamburger").click(function(){
		if($(".menu-wrapper").hasClass("menuopen")){
			$("#hamburger span").css("background","#00abad");
			$(".menu-wrapper").removeClass("menuopen");
		}else{
			$("#hamburger span").css("background","#ffffff");
			$(".menu-wrapper").addClass("menuopen");
		}
...
$(function() {
    ...
    var a = new SineWaves({
        el: document.getElementsByName("waves")[0],
            //设置正弦波速度 刘明注释
            speed: 4,
            width: function() {
        ...
        a1 = new SineWaves({
        el: document.getElementsByName("waves")[1],
        //设置正弦波速度 刘明注释
        speed: 4,
        width: function () {
            var a = $(document).width();
        ...
        a2 = new SineWaves({
            el: document.getElementsByName("waves")[2],
            //设置正弦波速度 刘明注释
            speed: 4,
            width: function () {
                var a = $(document).width();
		...
		a3 = new SineWaves({
            el: document.getElementsByName("waves")[3],
            //设置正弦波速度 刘明注释
            speed: 4,
            width: function () {
                var a = $(document).width();
    ...
    (c > e || f > d) && (a1.running = !1, a1.update()), $(window).bind("scroll", function () {
        c = $(document).scrollTop(), d = $(document).scrollTop() + $(window).height(), e = b1.offset().top + b1.height(), f = b1.offset().top, c > e || f > d ? (a1.running = !1, a1.update()) : (a1.running = !0, a1.update())
    });
    (c > e || f > d) && (a2.running = !1, a2.update()), $(window).bind("scroll", function () {
        c = $(document).scrollTop(), d = $(document).scrollTop() + $(window).height(), e = b2.offset().top + b2.height(), f = b2.offset().top, c > e || f > d ? (a2.running = !1, a2.update()) : (a2.running = !0, a2.update())
    });
	(c > e || f > d) && (a3.running = !1, a3.update()), $(window).bind("scroll", function () {
        c = $(document).scrollTop(), d = $(document).scrollTop() + $(window).height(), e = b3.offset().top + b3.height(), f = b3.offset().top, c > e || f > d ? (a3.running = !1, a3.update()) : (a3.running = !0, a3.update())
    });
});
